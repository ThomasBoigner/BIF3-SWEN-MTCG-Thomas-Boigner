...
public class CardControllerTest {
    ...
    void setUp() {
        ...
        cardController = new CardController(cardService, objectMapper);
    }

    @Test
    void ensureGetCardsWorksProperly() throws JsonProcessingException {
        // Given
        ...
        when(cardService.getCardsOfUser(eq("Thomas-mtgcToken"))).thenReturn(cardDtos);
