...
public enum DatabaseManager {
    ...
    public Connection getConnection() {
        try {
            ...
            """);
            connection.createStatement().execute("ALTER TABLE IF EXISTS mtcg.\"package\" OWNER to mtcgdb;");
            ...
            """);
            connection.createStatement().execute("ALTER TABLE IF EXISTS mtcg.card OWNER to mtcgdb;");
            ...
            connection.createStatement().execute("""
                ...
                INHERITS (mtcg.card);
            """);
            connection.createStatement().execute("ALTER TABLE IF EXISTS mtcg.monster_card OWNER to mtcgdb;");
            ...
            connection.createStatement().execute("""
                ...
                INHERITS (mtcg.card);
            """);
            connection.createStatement().execute("ALTER TABLE IF EXISTS mtcg.spell_card OWNER to mtcgdb;");
            ...
            """);
            connection.createStatement().execute("ALTER TABLE IF EXISTS mtcg.trade OWNER to mtcgdb;");
